    ...
    <section id="prestasi">
        <div class="container">
            ...
            <div class="section-item">
                <div class="row">
                    <div class="col-md-6">
                        <img class="section-item-thumbnail" src="assets/gambar/futsal.jpg" alt="">
                    </div>
                    <div class="col-md-6 col-item-kanan">
                        <div class="section-item-title">
                            <h3>Medali Emas dalam Turnamen Futsal Internasional di Indonesia</h3>
                            <div class="section-item-meta">
                                <span><i class="far fa-calendar-alt"></i> 20 Januari 2019 - 
                                31 Januari 2019</span>
                                <span><i class="fas fa-map-marked-alt"></i> Jakarta,
                                Indonesia</span>
                            </div>
                        </div>
                        <div class="section-item-body">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam neque amet 
                            facilis eius iusto aspernatur. Eligendi non quisquam esse provident debitis 
                            dolorum pariatur nesciunt, iure rerum veniam, amet voluptate ab.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-item">
                <div class="row">
                    <div class="col-md-6">
                        <img class="section-item-thumbnail" src="assets/gambar/juara-olimpiade.jpeg" alt="">
                    </div>
                    <div class="col-md-6 col-item-kanan">
                        <div class="section-item-title">
                            <h3>Medali Emas dalam Turnamen Futsal Internasional di Indonesia</h3>
